...
-no-emul-boot -boot-info-table -boot-load-size 4 -b magicos.ldr -c boot/grub4dos/boot.catalog -m '*_save*' \
-graft-points boot=../../../boot magicos.ldr=../magicos.ldr MagicOS=../../../MagicOS MagicOS-Data=../../../MagicOS-Data
